...
// MMK.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMMKApp, CWinApp)
...
// Единственный объект CMMKApp

CMMKApp theApp;


// Инициализация CMMKApp

BOOL CMMKApp::InitInstance()
{
